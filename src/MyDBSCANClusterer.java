 ...
 * @since 3.2
 */
public class MyDBSCANClusterer<T extends Clusterable> extends Clusterer<T> {
     ...
     */
    public MyDBSCANClusterer(final double eps, final int minPts)
     ...
     * @throws NotPositiveException if {@code eps < 0.0} or {@code minPts < 0}
     */
    public MyDBSCANClusterer(final double eps, final int minPts, final DistanceMeasure measure)
            throws NotPositiveException {
        super(measure);
